...
namespace BaseRevitModeless.ViewModel
{
	...
	public class PropertySelectionChangedViewModel : ViewModelBase
	{
		...
		public PropertySelectionChangedViewModel()
		{
		}


		public PropertySelectionChangedViewModel(ExternalCommandData rvtCommandData)
		{
			{
